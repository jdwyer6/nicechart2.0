...
function addToInstArray(){
    ...
    const percussion1 = document.getElementById('136')
    const percussion2 = document.getElementById('137')
    const malletPercussion = document.getElementById('138')
    const timpani = document.getElementById('139')
